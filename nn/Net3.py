...
class Net3(nn.Module):
    ...
    def train_iter(self, device, optimizer, train_loader, loss_f):
        accumulator = 0
        total = 0
        correct = 0
    ...
    def model_evaluation(self, device, lr, train_loader, test_loader, optimizer_f, epochs, weight):
        ...
        loss_f = nn.NLLLoss(weight = weight, reduction = "sum")
        ...
        for epoch in tqdm(np.arange(epochs)):
            ...
            train_loss, train_acc = self.train_iter(device, optimizer, train_loader, loss_f)
